...
const BookModal = ({ handleBookMenu, site }: BookModalProps) => {
          ...
          <div className="gradient-primary p-6 text-white relative overflow-hidden">
            ...
            <div className="relative z-10 flex items-center justify-between">
              <div className="space-y-2">
                <h2 className="font-display text-3xl font-bold">Book Viewing</h2>
            ...
            <div className="max-w-2xl mx-auto">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                <div className="text-center p-4 bg-secondary rounded-2xl">
                  ...
                  <p className="text-muted-foreground text-sm">Choose a time that works for you</p>
                </div>
                ...
                <div className="text-center p-4 bg-secondary rounded-2xl">
                  ...
                  <h3 className="font-semibold text-foreground mb-1">Expert Guide</h3>
                  <p className="text-muted-foreground text-sm">Professional agent assistance</p>
                </div>
                ...
                <div className="text-center p-4 bg-secondary rounded-2xl">
                  ...
                  <h3 className="font-semibold text-foreground mb-1">Detailed Tour</h3>
                  <p className="text-muted-foreground text-sm">Comprehensive property walkthrough</p>
                </div>
              </div>

...
export const metadata: Metadata = {
  metadataBase: new URL("https://www.lamonarealtors.co.ke"),
  title: {
  ...
  openGraph: {
    type: "website",
    url: "https://www.lamonarealtors.co.ke/",
    title: "Lamona Realtors - Find Your Dream Home in Kenya",
    description:
      "Discover exceptional properties with Lamona Realtors - Kenya's premier real estate agency. Expert guidance for buying, selling, and investing in prime real estate.",
    images: [{ url: "https://www.lamonarealtors.co.ke/images/logo_whitebg.png" }],
  ...
  twitter: {
    ...
    description:
      "Discover exceptional properties with Lamona Realtors - Kenya's premier real estate agency. Expert guidance for buying, selling, and investing in prime real estate.",
    images: ["https://www.lamonarealtors.co.ke/images/logo_whitebg.png"],
  },
  other: {
    "theme-color": "#101a15",
